          ...
          <div className="text-center py-12">
            ...
            <div className="mt-6">
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 mr-3"
              >
                Post a Ride
              </button>
              <button
